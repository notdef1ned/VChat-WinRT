...
namespace VChat.Backend.Helpers
{
    public static class ChatHelper
    {
        ...
        public const string GLOBAL = "Global Room";
        ...
        public const string SERVER_RUNNING = "Server is running";
        public const string SELECTED_USERNAME = "Chat with user {0}";
        #endregion
        ...
        #region Messages 
        public const string ErrorMessage = @"Please enter valid port number and/or server name";
        public static string WelcomeMessage = string.Format("{0}: ** Welcome to main chat room, Click on any user to start chat**\n", DateTime.Now.ToString("HH:mm:ss"));
        #endregion

        #region Splitters
        public static char MessageSpliter = '|';
        #endregion

        public class StateObject
        {
            // Client  socket.
            public IInputStream InputStream = null;
        ...
        {
            return message.Split(MessageSpliter);
        }
    }
    ...
    public class ConnectedClient
    {
        ...
        private readonly StreamSocket connection;
        public bool IsConnected { get; set; }
        public StreamSocket Connection
        {
        ...
        public ConnectedClient(string userName, StreamSocket connection)
        {
    ...
    /// <summary>
    /// Class that contains information to connect to chat server
    /// </summary>
    public class ConnectStruct
    {
        public ConnectStruct(int port, string hostName, string userName)
        {
            this.UserName = userName;
